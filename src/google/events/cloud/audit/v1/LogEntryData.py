...
class FirstPartyPrincipal:
    ...
    def __init__(self, principal_email: Optional[str], service_metadata: Optional[Dict[str, Any]]) -> None:
...
class ThirdPartyPrincipal:
    ...
    def __init__(self, third_party_claims: Optional[Dict[str, Any]]) -> None:
...
class ServiceAccountDelegationInfo:
    ...
    """Third party identity as the real authority."""
    third_party_principal: Optional[ThirdPartyPrincipal]

    def __init__(self, first_party_principal: Optional[FirstPartyPrincipal], third_party_principal: Optional[ThirdPartyPrincipal]) -> None:
...
class AuthorizationInfo:
    ...
    `AuditLogData.request_metadata.request_attributes`.
    """
    resource_attributes: Optional[ResourceAttributesClass]

    def __init__(self, granted: Optional[bool], permission: Optional[str], resource: Optional[str], resource_attributes: Optional[ResourceAttributesClass]) -> None:
...
class DestinationAttributes:
    ...
    def __init__(self, ip: Optional[str], labels: Optional[Dict[str, str]], port: Optional[int], principal: Optional[str], region_code: Optional[str]) -> None:
        self.ip = ip
        self.labels = labels
        self.port = port
...
class Request:
    ...
    def __init__(self, auth: Optional[Auth], headers: Optional[Dict[str, str]], host: Optional[str], id: Optional[str], method: Optional[str], path: Optional[str], protocol: Optional[str], query: Optional[str], reason: Optional[str], scheme: Optional[str], size: Optional[int], time: Optional[datetime]) -> None:
        self.auth = auth
...
class RequestMetadata:
    ...
    def __init__(self, caller_ip: Optional[str], caller_network: Optional[str], caller_supplied_user_agent: Optional[str], destination_attributes: Optional[DestinationAttributes], request_attributes: Optional[Request]) -> None:
...
class LogEntryData:
    ...
    the error.
    """
    resource: Optional[ResourceClass]
    """The severity of the log entry."""
    severity: Union[InsertID, int, None]
    ...
    def __init__(self, insert_id: Optional[str], labels: Optional[Dict[str, str]], log_name: Optional[str], operation: Optional[Operation], proto_payload: Optional[ProtoPayload], receive_timestamp: Optional[datetime], resource: Optional[ResourceClass], severity: Union[InsertID, int, None], span_id: Optional[str], timestamp: Optional[datetime], trace: Optional[str]) -> None:
