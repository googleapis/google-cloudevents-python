...
class AuditLog(_message.Message):
    __slots__ = ["authentication_info", "authorization_info", "metadata", "method_name", "num_response_items", "request", "request_metadata", "resource_location", "resource_name", "resource_original_state", "response", "service_data", "service_name", "status"]
    ...
    def __init__(self, service_name: Optional[str] = ..., method_name: Optional[str] = ..., resource_name: Optional[str] = ..., resource_location: Optional[Union[ResourceLocation, Mapping]] = ..., resource_original_state: Optional[Union[_struct_pb2.Struct, Mapping]] = ..., num_response_items: Optional[int] = ..., status: Optional[Union[_status_pb2.Status, Mapping]] = ..., authentication_info: Optional[Union[AuthenticationInfo, Mapping]] = ..., authorization_info: Optional[Iterable[Union[AuthorizationInfo, Mapping]]] = ..., request_metadata: Optional[Union[RequestMetadata, Mapping]] = ..., request: Optional[Union[_struct_pb2.Struct, Mapping]] = ..., response: Optional[Union[_struct_pb2.Struct, Mapping]] = ..., metadata: Optional[Union[_struct_pb2.Struct, Mapping]] = ..., service_data: Optional[Union[_struct_pb2.Struct, Mapping]] = ...) -> None: ...
...
class AuthenticationInfo(_message.Message):
    ...
    def __init__(self, principal_email: Optional[str] = ..., authority_selector: Optional[str] = ..., third_party_principal: Optional[Union[_struct_pb2.Struct, Mapping]] = ..., service_account_key_name: Optional[str] = ..., service_account_delegation_info: Optional[Iterable[Union[ServiceAccountDelegationInfo, Mapping]]] = ..., principal_subject: Optional[str] = ...) -> None: ...
...
class AuthorizationInfo(_message.Message):
    ...
    def __init__(self, resource: Optional[str] = ..., permission: Optional[str] = ..., granted: bool = ..., resource_attributes: Optional[Union[_attribute_context_pb2.AttributeContext.Resource, Mapping]] = ...) -> None: ...

class LogEntryData(_message.Message):
    __slots__ = ["insert_id", "labels", "log_name", "operation", "proto_payload", "receive_timestamp", "resource", "severity", "span_id", "split", "timestamp", "trace"]
    ...
    trace: str
    def __init__(self, log_name: Optional[str] = ..., resource: Optional[Union[_monitored_resource_pb2.MonitoredResource, Mapping]] = ..., proto_payload: Optional[Union[AuditLog, Mapping]] = ..., insert_id: Optional[str] = ..., labels: Optional[Mapping[str, str]] = ..., operation: Optional[Union[LogEntryOperation, Mapping]] = ..., timestamp: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., receive_timestamp: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., severity: Optional[Union[LogSeverity, str]] = ..., trace: Optional[str] = ..., span_id: Optional[str] = ..., split: Optional[Union[LogSplit, Mapping]] = ...) -> None: ...
...
class LogEntryOperation(_message.Message):
    ...
    last: bool
    producer: str
    def __init__(self, id: Optional[str] = ..., producer: Optional[str] = ..., first: bool = ..., last: bool = ...) -> None: ...
...
class LogSplit(_message.Message):
    ...
    total_splits: int
    uid: str
    def __init__(self, uid: Optional[str] = ..., index: Optional[int] = ..., total_splits: Optional[int] = ...) -> None: ...
...
class RequestMetadata(_message.Message):
    ...
    def __init__(self, caller_ip: Optional[str] = ..., caller_supplied_user_agent: Optional[str] = ..., caller_network: Optional[str] = ..., request_attributes: Optional[Union[_attribute_context_pb2.AttributeContext.Request, Mapping]] = ..., destination_attributes: Optional[Union[_attribute_context_pb2.AttributeContext.Peer, Mapping]] = ...) -> None: ...
...
class ResourceLocation(_message.Message):
    ...
    def __init__(self, current_locations: Optional[Iterable[str]] = ..., original_locations: Optional[Iterable[str]] = ...) -> None: ...
...
class ServiceAccountDelegationInfo(_message.Message):
    ...
    class FirstPartyPrincipal(_message.Message):
        ...
        def __init__(self, principal_email: Optional[str] = ..., service_metadata: Optional[Union[_struct_pb2.Struct, Mapping]] = ...) -> None: ...
    class ThirdPartyPrincipal(_message.Message):
        ...
        def __init__(self, third_party_claims: Optional[Union[_struct_pb2.Struct, Mapping]] = ...) -> None: ...
    ...
    def __init__(self, first_party_principal: Optional[Union[ServiceAccountDelegationInfo.FirstPartyPrincipal, Mapping]] = ..., third_party_principal: Optional[Union[ServiceAccountDelegationInfo.ThirdPartyPrincipal, Mapping]] = ...) -> None: ...
