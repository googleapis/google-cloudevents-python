...
class MapValueField:
    ...
    """A null value."""
    null_value: Union[BytesValue, int, None]
...
class DocumentEventData:
    ...
    This is only populated for update events.
    """
    update_mask: Optional[Mask]
    """A Document object containing a post-operation document snapshot.
    This is not populated for delete events.
    """
    value: Optional[Value]

    def __init__(self, old_value: Optional[OldValue], update_mask: Optional[Mask], value: Optional[Value]) -> None:
