...
class Document(_message.Message):
    ...
    def __init__(self, name: Optional[str] = ..., fields: Optional[Mapping[str, Value]] = ..., create_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., update_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ...) -> None: ...
...
class DocumentEventData(_message.Message):
    ...
    value: Document
    def __init__(self, value: Optional[Union[Document, Mapping]] = ..., old_value: Optional[Union[Document, Mapping]] = ..., update_mask: Optional[Union[DocumentMask, Mapping]] = ...) -> None: ...
...
class Value(_message.Message):
    __slots__ = ["array_value", "boolean_value", "bytes_value", "double_value", "geo_point_value", "integer_value", "map_value", "null_value", "reference_value", "string_value", "timestamp_value"]
    ...
    def __init__(self, null_value: Optional[Union[_struct_pb2.NullValue, str]] = ..., boolean_value: bool = ..., integer_value: Optional[int] = ..., double_value: Optional[float] = ..., timestamp_value: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., string_value: Optional[str] = ..., bytes_value: Optional[bytes] = ..., reference_value: Optional[str] = ..., geo_point_value: Optional[Union[_latlng_pb2.LatLng, Mapping]] = ..., array_value: Optional[Union[ArrayValue, Mapping]] = ..., map_value: Optional[Union[MapValue, Mapping]] = ...) -> None: ...
