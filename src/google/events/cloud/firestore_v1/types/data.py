...
class DocumentEventData(proto.Message):
    r"""The data within all Firestore document events.

    Attributes:
        value (google.events.cloud.firestore_v1.types.Document):
            A Document object containing a post-operation
            document snapshot. This is not populated for
            delete events.
        old_value (google.events.cloud.firestore_v1.types.Document):
            A Document object containing a pre-operation
            document snapshot. This is only populated for
            update and delete events.
        update_mask (google.events.cloud.firestore_v1.types.DocumentMask):
            A DocumentMask object that lists changed
            fields. This is only populated for update
            events.
    """

    value: 'Document' = proto.Field(
        proto.MESSAGE,
        number=1,
        message='Document',
    )
    old_value: 'Document' = proto.Field(
        proto.MESSAGE,
        number=2,
        message='Document',
    )
    update_mask: 'DocumentMask' = proto.Field(
        proto.MESSAGE,
        number=3,
...
class DocumentMask(proto.Message):
    r"""A set of field paths on a document.

    Attributes:
        field_paths (MutableSequence[str]):
            The list of field paths in the mask. See
            [Document.fields][google.cloud.firestore.v1.events.Document.fields]
...
class Document(proto.Message):
    ...
    Attributes:
        ...
        fields (MutableMapping[str, google.events.cloud.firestore_v1.types.Value]):
...
class Value(proto.Message):
    ...
    Attributes:
        ...
        geo_point_value (google.type.latlng_pb2.LatLng):
            ...
            This field is a member of `oneof`_ ``value_type``.
        array_value (google.events.cloud.firestore_v1.types.ArrayValue):
            An array value.
            ...
            This field is a member of `oneof`_ ``value_type``.
        map_value (google.events.cloud.firestore_v1.types.MapValue):
            A map value.
...
class ArrayValue(proto.Message):
    ...
    Attributes:
        values (MutableSequence[google.events.cloud.firestore_v1.types.Value]):
            Values in the array.
    """
