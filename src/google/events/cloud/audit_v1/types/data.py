...
class AuditLog(proto.Message):
    ...
    Attributes:
        ...
        authorization_info (Sequence[google.events.cloud.audit_v1.types.AuthorizationInfo]):
    ...
    resource_location = proto.Field(
        proto.MESSAGE,
        number=20,
        message="ResourceLocation",
    )
    resource_original_state = proto.Field(
        proto.MESSAGE,
        number=19,
        message=struct_pb2.Struct,
    )
    num_response_items = proto.Field(
        proto.INT64,
        number=12,
    )
    status = proto.Field(
    ...
    authentication_info = proto.Field(
        proto.MESSAGE,
        number=3,
        message="AuthenticationInfo",
    )
    authorization_info = proto.RepeatedField(
        proto.MESSAGE,
        number=9,
...
class AuthenticationInfo(proto.Message):
    ...
    Attributes:
        ...
        service_account_delegation_info (Sequence[google.events.cloud.audit_v1.types.ServiceAccountDelegationInfo]):
    ...
    authority_selector = proto.Field(
        proto.STRING,
        number=2,
    )
    third_party_principal = proto.Field(
        proto.MESSAGE,
        number=4,
        message=struct_pb2.Struct,
    )
...
class AuthorizationInfo(proto.Message):
    ...
    resource_attributes = proto.Field(
        proto.MESSAGE,
        number=5,
...
class RequestMetadata(proto.Message):
    ...
    caller_supplied_user_agent = proto.Field(
        proto.STRING,
        number=2,
    )
    caller_network = proto.Field(
        proto.STRING,
        number=3,
    )
    request_attributes = proto.Field(
        proto.MESSAGE,
        number=7,
        message=attribute_context_pb2.AttributeContext.Request,
    )
    destination_attributes = proto.Field(
        proto.MESSAGE,
        number=8,
...
class ResourceLocation(proto.Message):
    ...
    Attributes:
        current_locations (Sequence[str]):
            ...
            ::
                ...
                "us-east1"
                "nam3".
        original_locations (Sequence[str]):
    ...
    current_locations = proto.RepeatedField(
        proto.STRING,
        number=1,
    )
    original_locations = proto.RepeatedField(
        proto.STRING,
        number=2,
    )
...
class ServiceAccountDelegationInfo(proto.Message):
    ...
    class ThirdPartyPrincipal(proto.Message):
        ...
        third_party_claims = proto.Field(
            proto.MESSAGE,
            number=1,
            message=struct_pb2.Struct,
        )

    first_party_principal = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="Authority",
