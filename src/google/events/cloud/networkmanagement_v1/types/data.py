...
class Trace(proto.Message):
    ...
    Attributes:
        endpoint_info (google.events.cloud.networkmanagement_v1.types.EndpointInfo):
            ...
            between traces.
        steps (MutableSequence[google.events.cloud.networkmanagement_v1.types.Step]):
...
class Step(proto.Message):
    ...
    Attributes:
        ...
        state (google.events.cloud.networkmanagement_v1.types.Step.State):
        ...
        instance (google.events.cloud.networkmanagement_v1.types.InstanceInfo):
            Display information of a Compute Engine
            instance.

            This field is a member of `oneof`_ ``step_info``.
        firewall (google.events.cloud.networkmanagement_v1.types.FirewallInfo):
            Display information of a Compute Engine
            firewall rule.

            This field is a member of `oneof`_ ``step_info``.
        route (google.events.cloud.networkmanagement_v1.types.RouteInfo):
            Display information of a Compute Engine
            route.

            This field is a member of `oneof`_ ``step_info``.
        endpoint (google.events.cloud.networkmanagement_v1.types.EndpointInfo):
            ...
            This field is a member of `oneof`_ ``step_info``.
        google_service (google.events.cloud.networkmanagement_v1.types.GoogleServiceInfo):
            Display information of a Google service

            This field is a member of `oneof`_ ``step_info``.
        forwarding_rule (google.events.cloud.networkmanagement_v1.types.ForwardingRuleInfo):
            Display information of a Compute Engine
            forwarding rule.

            This field is a member of `oneof`_ ``step_info``.
        vpn_gateway (google.events.cloud.networkmanagement_v1.types.VpnGatewayInfo):
            Display information of a Compute Engine VPN
            gateway.

            This field is a member of `oneof`_ ``step_info``.
        vpn_tunnel (google.events.cloud.networkmanagement_v1.types.VpnTunnelInfo):
            Display information of a Compute Engine VPN
            tunnel.

            This field is a member of `oneof`_ ``step_info``.
        vpc_connector (google.events.cloud.networkmanagement_v1.types.VpcConnectorInfo):
            Display information of a VPC connector.

            This field is a member of `oneof`_ ``step_info``.
        deliver (google.events.cloud.networkmanagement_v1.types.DeliverInfo):
            Display information of the final state
            "deliver" and reason.

            This field is a member of `oneof`_ ``step_info``.
        forward (google.events.cloud.networkmanagement_v1.types.ForwardInfo):
            Display information of the final state
            "forward" and reason.

            This field is a member of `oneof`_ ``step_info``.
        abort (google.events.cloud.networkmanagement_v1.types.AbortInfo):
            Display information of the final state
            "abort" and reason.

            This field is a member of `oneof`_ ``step_info``.
        drop (google.events.cloud.networkmanagement_v1.types.DropInfo):
            Display information of the final state "drop"
            and reason.

            This field is a member of `oneof`_ ``step_info``.
        load_balancer (google.events.cloud.networkmanagement_v1.types.LoadBalancerInfo):
            Display information of the load balancers.

            This field is a member of `oneof`_ ``step_info``.
        network (google.events.cloud.networkmanagement_v1.types.NetworkInfo):
            Display information of a Google Cloud
            network.

            This field is a member of `oneof`_ ``step_info``.
        gke_master (google.events.cloud.networkmanagement_v1.types.GKEMasterInfo):
            Display information of a Google Kubernetes
            Engine cluster master.

            This field is a member of `oneof`_ ``step_info``.
        cloud_sql_instance (google.events.cloud.networkmanagement_v1.types.CloudSQLInstanceInfo):
            Display information of a Cloud SQL instance.

            This field is a member of `oneof`_ ``step_info``.
        cloud_function (google.events.cloud.networkmanagement_v1.types.CloudFunctionInfo):
            Display information of a Cloud Function.

            This field is a member of `oneof`_ ``step_info``.
        app_engine_version (google.events.cloud.networkmanagement_v1.types.AppEngineVersionInfo):
            Display information of an App Engine service
            version.

            This field is a member of `oneof`_ ``step_info``.
        cloud_run_revision (google.events.cloud.networkmanagement_v1.types.CloudRunRevisionInfo):
...
class FirewallInfo(proto.Message):
    ...
    Attributes:
        ...
        firewall_rule_type (google.events.cloud.networkmanagement_v1.types.FirewallInfo.FirewallRuleType):
...
class RouteInfo(proto.Message):
    ...
    Attributes:
        route_type (google.events.cloud.networkmanagement_v1.types.RouteInfo.RouteType):
            Type of route.
        next_hop_type (google.events.cloud.networkmanagement_v1.types.RouteInfo.NextHopType):
            Type of next hop.
        display_name (str):
...
class GoogleServiceInfo(proto.Message):
    ...
    Attributes:
        source_ip (str):
            Source IP address.
        google_service_type (google.events.cloud.networkmanagement_v1.types.GoogleServiceInfo.GoogleServiceType):
...
class LoadBalancerInfo(proto.Message):
    ...
    Attributes:
        load_balancer_type (google.events.cloud.networkmanagement_v1.types.LoadBalancerInfo.LoadBalancerType):
            Type of the load balancer.
        health_check_uri (str):
            URI of the health check for the load
            balancer.
        backends (MutableSequence[google.events.cloud.networkmanagement_v1.types.LoadBalancerBackend]):
            Information for the loadbalancer backends.
        backend_type (google.events.cloud.networkmanagement_v1.types.LoadBalancerInfo.BackendType):
...
class LoadBalancerBackend(proto.Message):
    ...
    Attributes:
        ...
        uri (str):
            ...
            endpoint.
        health_check_firewall_state (google.events.cloud.networkmanagement_v1.types.LoadBalancerBackend.HealthCheckFirewallState):
...
class VpnTunnelInfo(proto.Message):
    ...
    Attributes:
        ...
        region (str):
            Name of a Google Cloud region where this VPN
            tunnel is configured.
        routing_type (google.events.cloud.networkmanagement_v1.types.VpnTunnelInfo.RoutingType):
...
class DeliverInfo(proto.Message):
    ...
    Attributes:
        target (google.events.cloud.networkmanagement_v1.types.DeliverInfo.Target):
...
class ForwardInfo(proto.Message):
    ...
    Attributes:
        target (google.events.cloud.networkmanagement_v1.types.ForwardInfo.Target):
...
class AbortInfo(proto.Message):
    ...
    Attributes:
        cause (google.events.cloud.networkmanagement_v1.types.AbortInfo.Cause):
...
class DropInfo(proto.Message):
    ...
    Attributes:
        cause (google.events.cloud.networkmanagement_v1.types.DropInfo.Cause):
...
class ConnectivityTest(proto.Message):
    ...
    Attributes:
        ...
        source (google.events.cloud.networkmanagement_v1.types.Endpoint):
            ...
            intend to test.
        destination (google.events.cloud.networkmanagement_v1.types.Endpoint):
        ...
        reachability_details (google.events.cloud.networkmanagement_v1.types.ReachabilityDetails):
...
class Endpoint(proto.Message):
    ...
    Attributes:
        ...
        cloud_function (google.events.cloud.networkmanagement_v1.types.Endpoint.CloudFunctionEndpoint):
            A `Cloud Function <https://cloud.google.com/functions>`__.
        app_engine_version (google.events.cloud.networkmanagement_v1.types.Endpoint.AppEngineVersionEndpoint):
        ...
        cloud_run_revision (google.events.cloud.networkmanagement_v1.types.Endpoint.CloudRunRevisionEndpoint):
        ...
        network_type (google.events.cloud.networkmanagement_v1.types.Endpoint.NetworkType):
...
class ReachabilityDetails(proto.Message):
    ...
    Attributes:
        result (google.events.cloud.networkmanagement_v1.types.ReachabilityDetails.Result):
        ...
        traces (MutableSequence[google.events.cloud.networkmanagement_v1.types.Trace]):
...
class ConnectivityTestEventData(proto.Message):
    r"""The data within all ConnectivityTest events.

    .. _oneof: https://proto-plus-python.readthedocs.io/en/stable/fields.html#oneofs-mutually-exclusive-fields

    Attributes:
        payload (google.events.cloud.networkmanagement_v1.types.ConnectivityTest):
            Optional. The ConnectivityTest event payload.
            Unset for deletion events.

            This field is a member of `oneof`_ ``_payload``.
    """

    payload: 'ConnectivityTest' = proto.Field(
        proto.MESSAGE,
        number=1,
        optional=True,
