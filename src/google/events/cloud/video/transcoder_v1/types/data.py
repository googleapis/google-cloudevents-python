...
class Job(proto.Message):
    ...
    Attributes:
        ...
        config (google.events.cloud.video.transcoder_v1.types.JobConfig):
            The configuration for this job.

            This field is a member of `oneof`_ ``job_config``.
        state (google.events.cloud.video.transcoder_v1.types.Job.ProcessingState):
        ...
        error (google.rpc.status_pb2.Status):
            ...
            is ``FAILED``.
        mode (google.events.cloud.video.transcoder_v1.types.Job.ProcessingMode):
...
class JobConfig(proto.Message):
    ...
    Attributes:
        inputs (MutableSequence[google.events.cloud.video.transcoder_v1.types.Input]):
            List of input assets stored in Cloud Storage.
        edit_list (MutableSequence[google.events.cloud.video.transcoder_v1.types.EditAtom]):
            List of ``Edit atom``\ s. Defines the ultimate timeline of
            the resulting file or manifest.
        elementary_streams (MutableSequence[google.events.cloud.video.transcoder_v1.types.ElementaryStream]):
            List of elementary streams.
        mux_streams (MutableSequence[google.events.cloud.video.transcoder_v1.types.MuxStream]):
            List of multiplexing settings for output
            streams.
        manifests (MutableSequence[google.events.cloud.video.transcoder_v1.types.Manifest]):
            List of output manifests.
        output (google.events.cloud.video.transcoder_v1.types.Output):
            Output configuration.
        ad_breaks (MutableSequence[google.events.cloud.video.transcoder_v1.types.AdBreak]):
            List of ad breaks. Specifies where to insert
            ad break tags in the output manifests.
        pubsub_destination (google.events.cloud.video.transcoder_v1.types.PubsubDestination):
            Destination on Pub/Sub.
        sprite_sheets (MutableSequence[google.events.cloud.video.transcoder_v1.types.SpriteSheet]):
            List of output sprite sheets.
            Spritesheets require at least one VideoStream in
            the Jobconfig.
        overlays (MutableSequence[google.events.cloud.video.transcoder_v1.types.Overlay]):
...
class Input(proto.Message):
    ...
    Attributes:
        ...
        preprocessing_config (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig):
...
class ElementaryStream(proto.Message):
    ...
    Attributes:
        ...
        video_stream (google.events.cloud.video.transcoder_v1.types.VideoStream):
            Encoding of a video stream.

            This field is a member of `oneof`_ ``elementary_stream``.
        audio_stream (google.events.cloud.video.transcoder_v1.types.AudioStream):
            Encoding of an audio stream.

            This field is a member of `oneof`_ ``elementary_stream``.
        text_stream (google.events.cloud.video.transcoder_v1.types.TextStream):
...
class MuxStream(proto.Message):
    ...
    Attributes:
        ...
        elementary_streams (MutableSequence[str]):
            ...
            stream.
        segment_settings (google.events.cloud.video.transcoder_v1.types.SegmentSettings):
...
class Manifest(proto.Message):
    ...
    Attributes:
        file_name (str):
            ...
            ``Manifest.type``.
        type_ (google.events.cloud.video.transcoder_v1.types.Manifest.ManifestType):
...
class Overlay(proto.Message):
    ...
    Attributes:
        image (google.events.cloud.video.transcoder_v1.types.Overlay.Image):
            Image overlay.
        animations (MutableSequence[google.events.cloud.video.transcoder_v1.types.Overlay.Animation]):
    ...
    class Image(proto.Message):
        ...
        Attributes:
            uri (str):
                ...
                are supported.
            resolution (google.events.cloud.video.transcoder_v1.types.Overlay.NormalizedCoordinate):
    ...
    class AnimationStatic(proto.Message):
        ...
        Attributes:
            xy (google.events.cloud.video.transcoder_v1.types.Overlay.NormalizedCoordinate):
    ...
    class AnimationFade(proto.Message):
        ...
        Attributes:
            fade_type (google.events.cloud.video.transcoder_v1.types.Overlay.FadeType):
    ...
    class Animation(proto.Message):
        ...
        Attributes:
            animation_static (google.events.cloud.video.transcoder_v1.types.Overlay.AnimationStatic):
                Display static overlay object.

                This field is a member of `oneof`_ ``animation_type``.
            animation_fade (google.events.cloud.video.transcoder_v1.types.Overlay.AnimationFade):
                Display overlay object with fade animation.

                This field is a member of `oneof`_ ``animation_type``.
            animation_end (google.events.cloud.video.transcoder_v1.types.Overlay.AnimationEnd):
...
class PreprocessingConfig(proto.Message):
    ...
    Attributes:
        color (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Color):
            Color preprocessing configuration.
        denoise (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Denoise):
            Denoise preprocessing configuration.
        deblock (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Deblock):
            Deblock preprocessing configuration.
        audio (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Audio):
            Audio preprocessing configuration.
        crop (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Crop):
            Specify the video cropping configuration.
        pad (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Pad):
            Specify the video pad filter configuration.
        deinterlace (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Deinterlace):
    ...
    class Deinterlace(proto.Message):
        ...
        Attributes:
            yadif (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Deinterlace.YadifConfig):
                Specifies the Yet Another Deinterlacing
                Filter Configuration.

                This field is a member of `oneof`_ ``deinterlacing_filter``.
            bwdif (google.events.cloud.video.transcoder_v1.types.PreprocessingConfig.Deinterlace.BwdifConfig):
...
class VideoStream(proto.Message):
    ...
    Attributes:
        h264 (google.events.cloud.video.transcoder_v1.types.VideoStream.H264CodecSettings):
            H264 codec settings.

            This field is a member of `oneof`_ ``codec_settings``.
        h265 (google.events.cloud.video.transcoder_v1.types.VideoStream.H265CodecSettings):
            H265 codec settings.

            This field is a member of `oneof`_ ``codec_settings``.
        vp9 (google.events.cloud.video.transcoder_v1.types.VideoStream.Vp9CodecSettings):
            VP9 codec settings.
...
class AudioStream(proto.Message):
    ...
    Attributes:
        ...
        channel_layout (MutableSequence[str]):
            ...
            -  ``lfe`` - Low frequency
        mapping_ (MutableSequence[google.events.cloud.video.transcoder_v1.types.AudioStream.AudioMapping]):
...
class TextStream(proto.Message):
    ...
    Attributes:
        ...
        language_code (str):
            ...
            https://www.unicode.org/reports/tr35/#Unicode_locale_identifier.
            Not supported in MP4 files.
        mapping_ (MutableSequence[google.events.cloud.video.transcoder_v1.types.TextStream.TextMapping]):
...
class JobEventData(proto.Message):
    ...
    Attributes:
        payload (google.events.cloud.video.transcoder_v1.types.Job):
...
class JobTemplateEventData(proto.Message):
    r"""The data within all JobTemplate events.

    .. _oneof: https://proto-plus-python.readthedocs.io/en/stable/fields.html#oneofs-mutually-exclusive-fields

    Attributes:
        payload (google.events.cloud.video.transcoder_v1.types.JobTemplate):
            Optional. The JobTemplate event payload.
            Unset for deletion events.

            This field is a member of `oneof`_ ``_payload``.
    """

    payload: 'JobTemplate' = proto.Field(
        proto.MESSAGE,
        number=1,
        optional=True,
        message='JobTemplate',
