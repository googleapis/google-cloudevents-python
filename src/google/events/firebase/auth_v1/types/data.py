...
class AuthEventData(proto.Message):
    ...
    Attributes:
        ...
        provider_data (Sequence[google.events.firebase.auth_v1.types.UserInfo]):
    ...
    provider_data = proto.RepeatedField(
        proto.MESSAGE,
        number=8,
        message="UserInfo",
    )
