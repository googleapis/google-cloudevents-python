...
class AnalyticsLogData(proto.Message):
    ...
    Attributes:
        ...
        event_dim (Sequence[google.events.firebase.analytics_v1.types.EventDimensions]):
            A repeated record of event related
            dimensions.
    """

    user_dim = proto.Field(
        proto.MESSAGE,
        number=1,
        message="UserDimensions",
    )
    event_dim = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class UserDimensions(proto.Message):
    ...
    Attributes:
        ...
        user_properties (Mapping[str, google.events.firebase.analytics_v1.types.UserPropertyValue]):
    ...
    first_open_timestamp_micros = proto.Field(
        proto.INT64,
        number=2,
    )
    user_properties = proto.MapField(
        proto.STRING,
        proto.MESSAGE,
        number=3,
    ...
    geo_info = proto.Field(
        proto.MESSAGE,
        number=5,
        message="GeoInfo",
    )
    app_info = proto.Field(
        proto.MESSAGE,
        number=6,
        message="AppInfo",
    )
    traffic_source = proto.Field(
        proto.MESSAGE,
        number=7,
        message="TrafficSource",
    )
    bundle_info = proto.Field(
        proto.MESSAGE,
        number=8,
        message="ExportBundleInfo",
    )
    ltv_info = proto.Field(
        proto.MESSAGE,
        number=9,
        message="LtvInfo",
    )
...
class UserPropertyValue(proto.Message):
    ...
    set_timestamp_usec = proto.Field(
        proto.INT64,
        number=2,
    )
    index = proto.Field(
...
class DeviceInfo(proto.Message):
    ...
    device_category = proto.Field(
        proto.STRING,
        number=1,
    )
    mobile_brand_name = proto.Field(
        proto.STRING,
        number=2,
    )
    mobile_model_name = proto.Field(
        proto.STRING,
        number=3,
    )
    mobile_marketing_name = proto.Field(
        proto.STRING,
        number=4,
    )
    ...
    resettable_device_id = proto.Field(
        proto.STRING,
        number=8,
    )
    user_default_language = proto.Field(
        proto.STRING,
        number=9,
    )
    device_time_zone_offset_seconds = proto.Field(
        proto.INT32,
        number=10,
    )
    limited_ad_tracking = proto.Field(
        proto.BOOL,
        number=11,
    )
...
class AppInfo(proto.Message):
    ...
    app_version = proto.Field(
        proto.STRING,
        number=1,
    )
    app_instance_id = proto.Field(
        proto.STRING,
        number=2,
    )
...
class TrafficSource(proto.Message):
    ...
    user_acquired_campaign = proto.Field(
        proto.STRING,
        number=2,
    )
    user_acquired_source = proto.Field(
        proto.STRING,
        number=3,
    )
    user_acquired_medium = proto.Field(
        proto.STRING,
        number=4,
    )
...
class ExportBundleInfo(proto.Message):
    ...
    bundle_sequence_id = proto.Field(
        proto.INT32,
        number=1,
    )
    server_timestamp_offset_micros = proto.Field(
        proto.INT64,
        number=2,
    )
...
class EventDimensions(proto.Message):
    ...
    Attributes:
        ...
        params (Mapping[str, google.events.firebase.analytics_v1.types.AnalyticsValue]):
    ...
    previous_timestamp_micros = proto.Field(
        proto.INT64,
        number=5,
    )
    value_in_usd = proto.Field(
        proto.DOUBLE,
        number=7,
    )
