...
class AuthEventData(proto.Message):
    ...
    Attributes:
        value (google.events.firebase.auth_v2.types.User):
            This is not populated for delete events.
        old_value (google.events.firebase.auth_v2.types.User):
            This is only populated for update and delete
            events.
    """

    value: 'User' = proto.Field(
        proto.MESSAGE,
        number=1,
        message='User',
    )
    old_value: 'User' = proto.Field(
        proto.MESSAGE,
        number=2,
        message='User',
    )
...
class User(proto.Message):
    r"""The user for this Firebase Auth event.
    ...
    Attributes:
        ...
        metadata (google.events.firebase.auth_v2.types.UserMetadata):
            Additional metadata about the user.
        provider_data (MutableSequence[google.events.firebase.auth_v2.types.UserInfo]):
