...
class AnalyticsLogData(_message.Message):
    ...
    def __init__(self, user_dim: Optional[Union[UserDimensions, Mapping]] = ..., event_dim: Optional[Iterable[Union[EventDimensions, Mapping]]] = ...) -> None: ...
...
class AnalyticsValue(_message.Message):
    ...
    int_value: int
    string_value: str
    def __init__(self, string_value: Optional[str] = ..., int_value: Optional[int] = ..., float_value: Optional[float] = ..., double_value: Optional[float] = ...) -> None: ...

class AppInfo(_message.Message):
    __slots__ = ["app_id", "app_instance_id", "app_platform", "app_store", "app_version"]
    ...
    app_store: str
    app_version: str
    def __init__(self, app_version: Optional[str] = ..., app_instance_id: Optional[str] = ..., app_store: Optional[str] = ..., app_platform: Optional[str] = ..., app_id: Optional[str] = ...) -> None: ...

class DeviceInfo(_message.Message):
    __slots__ = ["device_category", "device_id", "device_model", "device_time_zone_offset_seconds", "limited_ad_tracking", "mobile_brand_name", "mobile_marketing_name", "mobile_model_name", "platform_version", "resettable_device_id", "user_default_language"]
    ...
    def __init__(self, device_category: Optional[str] = ..., mobile_brand_name: Optional[str] = ..., mobile_model_name: Optional[str] = ..., mobile_marketing_name: Optional[str] = ..., device_model: Optional[str] = ..., platform_version: Optional[str] = ..., device_id: Optional[str] = ..., resettable_device_id: Optional[str] = ..., user_default_language: Optional[str] = ..., device_time_zone_offset_seconds: Optional[int] = ..., limited_ad_tracking: bool = ...) -> None: ...

class EventDimensions(_message.Message):
    __slots__ = ["date", "name", "params", "previous_timestamp_micros", "timestamp_micros", "value_in_usd"]
    class ParamsEntry(_message.Message):
        ...
        def __init__(self, key: Optional[str] = ..., value: Optional[Union[AnalyticsValue, Mapping]] = ...) -> None: ...
    ...
    value_in_usd: float
    def __init__(self, date: Optional[str] = ..., name: Optional[str] = ..., params: Optional[Mapping[str, AnalyticsValue]] = ..., timestamp_micros: Optional[int] = ..., previous_timestamp_micros: Optional[int] = ..., value_in_usd: Optional[float] = ...) -> None: ...
...
class GeoInfo(_message.Message):
    ...
    country: str
    region: str
    def __init__(self, continent: Optional[str] = ..., country: Optional[str] = ..., region: Optional[str] = ..., city: Optional[str] = ...) -> None: ...
...
class LtvInfo(_message.Message):
    ...
    currency: str
    revenue: float
    def __init__(self, revenue: Optional[float] = ..., currency: Optional[str] = ...) -> None: ...

class TrafficSource(_message.Message):
    __slots__ = ["user_acquired_campaign", "user_acquired_medium", "user_acquired_source"]
    ...
    def __init__(self, user_acquired_campaign: Optional[str] = ..., user_acquired_source: Optional[str] = ..., user_acquired_medium: Optional[str] = ...) -> None: ...

class UserDimensions(_message.Message):
    __slots__ = ["app_info", "bundle_info", "device_info", "first_open_timestamp_micros", "geo_info", "ltv_info", "traffic_source", "user_id", "user_properties"]
    class UserPropertiesEntry(_message.Message):
        ...
        def __init__(self, key: Optional[str] = ..., value: Optional[Union[UserPropertyValue, Mapping]] = ...) -> None: ...
    ...
    def __init__(self, user_id: Optional[str] = ..., first_open_timestamp_micros: Optional[int] = ..., user_properties: Optional[Mapping[str, UserPropertyValue]] = ..., device_info: Optional[Union[DeviceInfo, Mapping]] = ..., geo_info: Optional[Union[GeoInfo, Mapping]] = ..., app_info: Optional[Union[AppInfo, Mapping]] = ..., traffic_source: Optional[Union[TrafficSource, Mapping]] = ..., bundle_info: Optional[Union[ExportBundleInfo, Mapping]] = ..., ltv_info: Optional[Union[LtvInfo, Mapping]] = ...) -> None: ...
...
class UserPropertyValue(_message.Message):
    ...
    value: AnalyticsValue
    def __init__(self, value: Optional[Union[AnalyticsValue, Mapping]] = ..., set_timestamp_usec: Optional[int] = ..., index: Optional[int] = ...) -> None: ...
