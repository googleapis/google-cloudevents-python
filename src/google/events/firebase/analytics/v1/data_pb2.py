...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.events.firebase.analytics.v1.data_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\252\002,Google.Events.Protobuf.Firebase.Analytics.V1'
