...
class MonitoredResourceDescriptor(_message.Message):
    ...
    def __init__(
        ...
        labels: Optional[Iterable[Union[_label_pb2.LabelDescriptor, Mapping]]] = ...,
        launch_stage: Optional[Union[_launch_stage_pb2.LaunchStage, str]] = ...,
    ) -> None: ...
...
class MonitoredResourceMetadata(_message.Message):
    ...
    def __init__(
        self,
        system_labels: Optional[Union[_struct_pb2.Struct, Mapping]] = ...,
        user_labels: Optional[Mapping[str, str]] = ...,
    ) -> None: ...
